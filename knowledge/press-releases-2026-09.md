...
Куда отправлять и что дают премии — [[award-pr-channels]]. **Ничего не отправлено.** Цитаты помечены как заготовки: их должен дать Антон Варгов своими словами, иначе это будет выдуманная цитата от его имени.
