...
**Варианты по лицензии, вынесены владельцу:**
1. оставить CC-BY со скачиванием — дизайнер берёт модель в проект и приходит с готовым решением; обратная сторона: геометрию можно отдать в производство мимо бренда;
2. CC-BY-ND — в проект вставить можно, переделывать нельзя; от производства не защищает, но даёт основание для претензии;
3. закрыть скачивание, оставив просмотр и AR — копирование закрыто, но исчезает причина, по которой дизайнеры туда идут. Довод агента: на 3ddd 5045 карточек с открытыми файлами, и закрывать Sketchfab, оставляя 3ddd открытым, — «защита от честных».
