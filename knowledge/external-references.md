...
- Facebook: facebook.com/vargovdesign — страница бренда «vargov_design» (1,2 тыс. подписчиков, телефон +7 916 537-33-52). **Внимание (проверено 05.09.2026):** в описании страницы написано «Производство осуществляется на эксклюзивной фабрике Vargov®Design в Китае», ссылка ведёт на vargov.design, а пост от 04.08.2025 называет xprojectlight.ru «official distributor in Russia» и перечисляет материалы. **Исправлено 05.09.2026 вечером:** краткая биография заменена на формулировку владельца (без страны производства, 23 награды); ссылка в разделе «Ссылки» — https://vargov.ru/; подпись к обложке от 04.12.2025 переписана (фраза про фабрику в Китае удалена, добавлены Product Designer of the Year и 23 награды). **Осталось владельцу:** пост от 04.08.2025 (Interlight, «official distributor in Russia — xprojectlight.ru», материалы) опубликован через Metricool — у него нет «Редактировать», только «Удалить публикацию»; удаление — действие владельца (пост → «…» → Удалить публикацию). Страница в sameAs сайта — команда агенту сайта дана 05.09 (описание и ссылка уже верные).
- Pinterest: https://www.pinterest.com/Vargov_Design/ — домен vargov.ru подтверждён (p:domain_verify), в sameAs сайта и базы с 05.09.2026.
...
- **Alibaba**, поставщик поставщик A: листинг «Custom Vargov Design LED
  ...
  свяжет бренд с оптовой китайской люстрой. Пакет жалобы — (материалы по защите знака — вне репозитория).
