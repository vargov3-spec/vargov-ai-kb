...
| — | Яндекс Карты | карточка «Vargov design» на Нахимовском | помечена «не работает», чужой сайт | ждёт подтверждения владельцем, см. [[maps-cards]] |
| — | Google Карты | — | карточки нет | создать, см. [[maps-cards]] |
