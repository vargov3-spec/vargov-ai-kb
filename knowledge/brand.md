...
- **машиночитаемый слой базы** — 603 прямые карточки `/3dmodels/show/<slug>` в `subjectOf` каждого Product: у карточки есть название, автор и превью, у списка — нет. Для языковых моделей прямой адрес содержательнее.
