...
**Как решается спор «реестр владельца против выдачи тега»** (правило выведено 07.09.2026 вместе с агентами сайта и конфигуратора; расхождений было 27 из 43 ручных записей реестра):
1. Карточка, названная **кодом самого артикула**, сильнее карточки без кода — откуда бы она ни пришла. Так реестр проиграл у 11 артикулов: показателен LC0199 — каталог зовёт его торшером, тег даёт `torsher-…-lc0199`, а реестр вёл на декоративную перегородку-ширму (нашёл агент сайта).
2. Обе с кодом — берём реестр: там владелец выбирал конкретный экземпляр вручную (LC0543, LC0545, LC0332).
3. Обе без кода, но тег отдал ровно одну карточку — она и есть (LC0049).
4. Обе без кода — смотрим, какой тег стоит НА карточке: это тоже разметка владельца, и она сильнее отсутствия кода в слаге. По переписи агента сайта (для каждого артикула слаги, отданные по его тегу) реестровые карточки LC0062, LC0085, LC0086 и LC0172 несут тег своего артикула — представитель им оставлен. Сирота один: **LC0004**, его реестровая карточка помечена тегом LC0176, а по тегу lc0004 идут пять других карточек без кода. Ему представителя не назначаем, остаётся список моделей.

Отсюда счёт: **602 прямые карточки** и 597 списков на 605 артикулов. Старые карточки названы вообще без артикула (`droplight_vargov_design_100` у LC0062), поэтому «в слаге нет своего кода» — не повод снимать ссылку; у LC0529 владелец сам указал карточку `…lc0528-3`, и тег `lc0529` не пуст.
