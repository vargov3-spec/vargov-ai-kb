...
Проверка всех 45 прямых записей реестра тегами карточек дала три ошибки, где стоит карточка чужого изделия: **LC0199** (теги несут `lc0150`; каталог зовёт его торшером, а карточка — декоративная перегородка-ширма), **LC0004** (теги несут `lc0176`) и **LC0049** (артикульных тегов нет вовсе). У первых двух есть собственная помеченная карточка, её и берём. LC0049 — единственное место, где два ручных действия владельца противоречат: в реестре он выбрал `hover_stone_collection_mardin_shine`, а тегом `lc0049` пометил `liustra_light_vargov_33`. В графе стоит помеченная тегом, вопрос вынесен владельцу с превью обеих карточек.
