...
**Порядок источников слага:** реестр владельца → слаг из списка аккаунта, оканчивающийся кодом артикула → выгрузка по тегу. При этом «в слаге чужой код» само по себе не повод снимать ссылку: старые карточки названы вообще без артикула (`droplight_vargov_design_100` у LC0062), а у LC0529 владелец сам указал карточку `…lc0528-3` и тег `lc0529` не пуст. Во всей базе слаг с чужим кодом один — этот, и он верный.
