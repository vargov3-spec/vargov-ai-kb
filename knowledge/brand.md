...
4. Обе без кода и карточек по тегу много — **представителя не назначаем вовсе**: LC0004, LC0062, LC0085, LC0086, LC0172. У них остаётся только список моделей по тегу. Объективного признака нет, а угадывать нельзя; разрешить может лишь владелец, глядя на карточки.

Отсюда счёт: **598 прямых карточек** и 597 списков на 605 артикулов. Старые карточки названы вообще без артикула (`droplight_vargov_design_100` у LC0062), поэтому «в слаге нет своего кода» — не повод снимать ссылку; у LC0529 владелец сам указал карточку `…lc0528-3`, и тег `lc0529` не пуст.
