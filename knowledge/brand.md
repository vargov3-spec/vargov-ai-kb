...
**Последнее слово — за картинкой.** Когда теги и реестр противоречат, спор решает сравнение превью карточки с обложкой изделия в каталоге: обложку согласовывал владелец, и это изображение самой вещи, а не её разметки. Так 07.09.2026 закрылся LC0049 — обложка показывает жилу янтаря, неправильные окатанные камни, то есть ровно карточку реестра `hover_stone_collection_mardin_shine`, а помеченная тегом `lc0049` `liustra_light_vargov_33` — мелкие круглые шарики, другое изделие: тег на ней проставлен ошибочно, запись реестра верна. Тем же способом подтверждён LC0004: обложка — капли, и карточка `avtorskii_svetilnik_vargov_design_15` это они же. Ошибок реестра осталось две: LC0199 и LC0004.
