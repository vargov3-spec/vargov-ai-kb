...
## Технические детали из анкет премий

Технические характеристики из анкет премий хранятся вне репозитория (папка PR владельца, файл `awards-verified-private-2026-09-06.md`); в открытых материалах не используются (правило владельца: материалы, размеры и мощность в карточках, JSON-LD, Pinterest и пресс-материалах не называются). Вынесено 06.09.2026.
...
## Наградных знаков на снимках как минимум два — и это граница нашей проверки

Найдено агентом сайта 13.09.2026 при проверке устойчивости детектора наклеек.

Кроме золотого знака в съёмке встречается **SIT Furniture Design Award, WINNER
2025** — красный логотип на белой полосе под изделием, занимающей почти половину
кадра. Он **не золотой**, и весь инструмент, которым мы сегодня чистили галереи,
ищет золото. Такой кадр прошёл бы мимо обоих сторожей на всех 614 страницах с
рапортом «чисто».

**Поэтому «проверено на наклейки» до 13.09.2026 означает «проверено на золотой
знак».** Ссылаясь где-либо на нашу проверку каталога, ставить эту границу рядом.

Сплошной прогон по признаку «белая полоса внизу на тёмной съёмке» дал по всем
7041 изображению сайта ровно два кадра, и оба безопасны: сам знак SIT (убран из
галерей, помечен на выброс без замены — генератор это отрабатывает) и
`/img/awards/iconic-selection-2023.png`, который логотипом и должен быть. Второй
проход другим признаком — насыщенный красный где угодно в кадре, без привязки к
вёрстке знака — идёт отдельно: в съёмке бренда стекло, хрусталь, латунь и чёрный
фон, красному взяться неоткуда.

SIT Furniture Design Award — награды № 9 (2025, LC0358) и № 10 (2023, LC0292) в
таблице выше.